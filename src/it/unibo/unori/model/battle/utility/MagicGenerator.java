...
public final class MagicGenerator {
    ...
    public static MagicAttackInterface getBasic() {
        return new MagicAttack("Schiaffo", "Che schiaffo!", 
                "Non c'Ë nulla di magico in uno schiaffo", 0, 0, 0, 1, 10, 1);
    }
        ...
        if (j == null) {
            ...
            switch (j) {
                case WARRIOR : mag = new MagicAttack("Mazzata Magica",
                        ...
                        "Una mazza chiodata che pu√≤ causare gravi danni fisici",
                ...
                case CLOWN : mag = new MagicAttack("BUH!",
                        ...
                        "Uno spavento che puÚ far scendere il gelo",
        ...
        if (j == null) {
            ...
            switch (j) {
                ...
                case RANGER : mag = new MagicAttack("Autorita'† Imponente",
                        "Hai usato la tua autorit√† per colpire!",
