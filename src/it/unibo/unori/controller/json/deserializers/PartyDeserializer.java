...
public class PartyDeserializer implements JsonDeserializer<Party> {
    ...
    public Party deserialize(final JsonElement json, final Type typeOfT, final JsonDeserializationContext context)
        ...
        // final Map<CardinalPoints, String> frames = new HashMap<CardinalPoints,
        // String>(context.deserialize(jObj.get(FRAMES), new TypeToken<Map<CardinalPoints, String>>() {
        ...
        return context.deserialize(json, SingletonParty.getParty().getClass()); // TODO I'm not sure this would work,
                                                                                // but for now it's OK
    }
